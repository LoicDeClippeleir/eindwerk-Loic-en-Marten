...
namespace SimpleschoolApp.Controllers
{
    public class VakkenController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Naam,Taal,AantalStudiePunten,Type")] Vak vak)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Naam,Taal,AantalStudiePunten,Type")] Vak vak)
        {
            if (id != vak.Id)
            {
                return NotFound();
