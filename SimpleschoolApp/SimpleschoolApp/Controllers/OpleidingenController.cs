...
namespace SimpleschoolApp.Controllers
{
    public class OpleidingenController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Opleiding.Include(o => o.Leerling);
        ...
        {
            ViewData["LeerlingId"] = new SelectList(_context.Leerling, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Naam,Duur,BeschikbarePlaatsen,Beschrijving,LeerlingId")] Opleiding opleiding)
        {
            ...
            ViewData["LeerlingId"] = new SelectList(_context.Leerling, "Id", "Id", opleiding.LeerlingId);
            return View(opleiding);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Naam,Duur,BeschikbarePlaatsen,Beschrijving,LeerlingId")] Opleiding opleiding)
        {
            if (id != opleiding.Id)
            {
                return NotFound();
