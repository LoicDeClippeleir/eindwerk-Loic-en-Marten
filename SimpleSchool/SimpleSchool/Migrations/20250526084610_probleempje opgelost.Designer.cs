...
namespace SimpleSchool.Migrations
{
    ...
    [Migration("20250526084610_probleempje opgelost")]
    partial class probleempjeopgelost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SimpleSchool.Models.Leerkracht", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Adres = "Noapark 5",
                            EMail = "et",
                            GeboorteDatum = new DateTime(2024, 10, 26, 18, 35, 42, 8, DateTimeKind.Local).AddTicks(2602),
                            Naam = "Jayden Bruin"
                        },
                        new
                        {
                            ...
                            EMail = "dolorem",
                            GeboorteDatum = new DateTime(2024, 6, 16, 18, 56, 13, 838, DateTimeKind.Local).AddTicks(4192),
                        ...
                        new
                        {
                            ...
                            EMail = "soluta",
                            GeboorteDatum = new DateTime(2024, 11, 25, 6, 36, 37, 506, DateTimeKind.Local).AddTicks(286),
                            Naam = "Maud Wit"
                        },
                        new
                        {
                            ...
                            EMail = "voluptatem",
                            GeboorteDatum = new DateTime(2024, 11, 3, 22, 50, 17, 946, DateTimeKind.Local).AddTicks(7445),
                            Naam = "Julian Bakker"
                        },
                        new
                        {
                            ...
                            EMail = "dolor",
                            GeboorteDatum = new DateTime(2024, 8, 29, 0, 14, 5, 129, DateTimeKind.Local).AddTicks(6734),
                            Naam = "Amber Schouten"
                        },
                        new
                        {
                            ...
                            EMail = "vel",
                            GeboorteDatum = new DateTime(2024, 8, 29, 0, 58, 19, 945, DateTimeKind.Local).AddTicks(971),
                            Naam = "Thijs Visser"
                        },
                        new
                        {
                            ...
                            Adres = "Brinkweg 0",
                            EMail = "et",
                            GeboorteDatum = new DateTime(2025, 2, 6, 7, 25, 23, 872, DateTimeKind.Local).AddTicks(3836),
                            Naam = "Bas Broek"
                        },
                        new
                        {
                            ...
                            EMail = "consequatur",
                            GeboorteDatum = new DateTime(2024, 10, 23, 21, 50, 40, 309, DateTimeKind.Local).AddTicks(688),
                            Naam = "Nick Smits"
                        },
                        new
                        {
                            ...
                            EMail = "ipsam",
                            GeboorteDatum = new DateTime(2025, 4, 4, 15, 37, 44, 320, DateTimeKind.Local).AddTicks(9614),
                            Naam = "Bas Dekker"
                        },
                        new
                        {
                            ...
                            EMail = "ducimus",
                            GeboorteDatum = new DateTime(2024, 9, 16, 5, 11, 39, 412, DateTimeKind.Local).AddTicks(2583),
                            Naam = "Jasper Smits"
                        });
                });
            ...
            modelBuilder.Entity("SimpleSchool.Models.Leerling", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EMail = "facere",
                            GeboorteDatum = new DateTime(2024, 9, 27, 22, 40, 2, 55, DateTimeKind.Local).AddTicks(254),
                            Naam = "Tim Meer",
                            OpleidingId = 11,
                            StudentenkaartId = 11
                        },
                        new
                        {
                            ...
                            EMail = "pariatur",
                            GeboorteDatum = new DateTime(2024, 10, 9, 23, 18, 58, 364, DateTimeKind.Local).AddTicks(1080),
                            Naam = "Sanne Graaf",
                            OpleidingId = 12,
                            StudentenkaartId = 12
                        },
                        new
                        {
                            ...
                            EMail = "magni",
                            GeboorteDatum = new DateTime(2024, 7, 1, 7, 16, 19, 55, DateTimeKind.Local).AddTicks(3769),
                            Naam = "Britt Hendriks",
                            OpleidingId = 13,
                            StudentenkaartId = 13
                        },
                        new
                        {
                            ...
                            EMail = "est",
                            GeboorteDatum = new DateTime(2025, 4, 3, 21, 59, 34, 651, DateTimeKind.Local).AddTicks(2137),
                            Naam = "Julian Brouwer",
                            OpleidingId = 14,
                            StudentenkaartId = 14
                        },
                        new
                        {
                            ...
                            GeboorteDatum = new DateTime(2025, 1, 19, 15, 29, 10, 255, DateTimeKind.Local).AddTicks(1597),
                            Naam = "Femke Ven",
                            OpleidingId = 15,
                            StudentenkaartId = 15
                        },
                        new
                        {
                            ...
                            EMail = "et",
                            GeboorteDatum = new DateTime(2025, 2, 15, 22, 3, 19, 414, DateTimeKind.Local).AddTicks(4142),
                            Naam = "Sven Meijer",
                            OpleidingId = 16,
                            StudentenkaartId = 16
                        },
                        new
                        {
                            ...
                            EMail = "tenetur",
                            GeboorteDatum = new DateTime(2024, 10, 7, 1, 20, 39, 448, DateTimeKind.Local).AddTicks(3417),
                            Naam = "Eva Peters",
                            OpleidingId = 17,
                            StudentenkaartId = 17
                        },
                        new
                        {
                            ...
                            EMail = "aut",
                            GeboorteDatum = new DateTime(2025, 3, 9, 16, 44, 33, 466, DateTimeKind.Local).AddTicks(7106),
                            Naam = "Thijs Broek",
                            OpleidingId = 18,
                            StudentenkaartId = 18
                        },
                        new
                        {
                            ...
                            EMail = "ut",
                            GeboorteDatum = new DateTime(2024, 11, 23, 18, 5, 20, 710, DateTimeKind.Local).AddTicks(2793),
                            Naam = "Stijn Wit",
                            OpleidingId = 19,
                            StudentenkaartId = 19
                        },
                        new
                        {
                            ...
                            EMail = "quia",
                            GeboorteDatum = new DateTime(2024, 9, 23, 12, 13, 43, 785, DateTimeKind.Local).AddTicks(1643),
                            Naam = "Bram Brink",
                            OpleidingId = 20,
                            StudentenkaartId = 20
                        });
